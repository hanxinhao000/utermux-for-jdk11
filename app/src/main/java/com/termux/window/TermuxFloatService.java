...
public class TermuxFloatService extends Service {
    ...
    public void onCreate() {
        ...
        Log.e("xinhao_han", "onCreate: 服务器已启动" );
        ...
        Log.e("xinhao_han", "onCreate: 服务器已启动1" );
        ...
        Log.e("xinhao_han", "onCreate: 服务器已启动2" );
        ...
        Log.e("xinhao_han", "onCreate: 服务器已启动3" );
        try {
        ...
        Log.e("xinhao_han", "onCreate: 服务器已启动4" );
      ...
      //  if (v != null) v.setGravity(Gravity.CENTER);
       // toast.show();
        Log.e("xinhao_han", "onCreate: 服务器已启动5" );
    ...
    private Notification buildNotification() {
        ...
        Notification.Builder builder = new Notification.Builder(this).setContentTitle(contentTitle).setContentText(contentText)
            .setPriority(Notification.PRIORITY_MIN).setSmallIcon(R.mipmap.dsfsdfsdf)
            .setColor(0xFF000000)
    ...
    TerminalSession createTermSession() {
        ...
        Log.e("xinhao_han", "onCreate: 服务器已启动6" );
        ...
        Log.e("xinhao_han", "onCreate: 服务器已启动7" );
        ...
        Log.e("xinhao_han", "onCreate: 服务器已启动8" );
        return new TerminalSession(executablePath, HOME_PATH, args, env, new TerminalSession.SessionChangedCallback() {
            ...
            public void onSessionFinished(TerminalSession finishedSession) {
                ...
                Log.e("xinhao_han", "onCreate: 服务器已启动9" );
